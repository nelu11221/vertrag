      ...
      >
        ...
        <div style={{ padding: '32px 36px 36px' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '4px 12px', background: 'rgba(231,76,60,0.1)', border: '1px solid rgba(231,76,60,0.2)', borderRadius: 99, marginBottom: 16 }}>
            ...
            <span style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#e74c3c' }}>Soluție disponibilă</span>
          </div>
...
const ALL = [
  {
    ...
    subcategorii: [
      ...
      { img: '/images/ind1_6.jpg', title: 'Filme rigidе', desc: 'Foarte important, filmele PET sunt supuse unei reciclări eficiente, ceea ce le face una dintre cele mai ecologice alternative față de alți polimeri.' },
      ...
      { img: '/images/ind1_11.jpg', title: 'Filme Flow-Pack microperforate', desc: 'Filme destinate special produselor crud-uscate, produselor leguminoase, de panificație, produse care necesită transfer de aer – „produsul să respire”..' },
      ...
      { img: '/images/ind1_14.jpg', title: 'Folii FlowVac termocontractibile', desc: 'Produse care acoperă o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate..' },
      { img: '/images/ind1_15.jpg', title: 'Folii din polietilenă', desc: 'Pungile termocontractibile garantează ambalajul produsului în întregul lanț de producție, transport și vânzare..' },
      ...
      { img: '/images/ind1_18.jpg', title: 'Caserole PP', desc: 'Caserolele PET/PE, mono PET și PP sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      ...
      { img: '/images/ind1_23.jpg', title: 'Caserole Mono PET', desc: 'Caserolele PET/PE, mono PET și PP sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
  ...
  },
  {
    ...
    subcategorii: [
      ...
      { img: '/images/ind1_2.jpg', title: 'Filme rigidе', desc: 'sunt utilizate pentru producerea ambalajelor folosind un proces de termoformare.' },
      ...
      { img: '/images/ind1_2.jpg', title: 'Folii Stretch alimentare', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_2.jpg', title: 'Folii Poliolefină termocontractibile', desc: ' ' },
      { img: '/images/ind1_2.jpg', title: 'Folii FlowVac termocontractibile', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_2.jpg', title: 'Folii din polietilenă', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_2.jpg', title: 'Saci pentru navete', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind2_5.jpg', title: 'Caserole PP', desc: 'Caserolele PET/PE, mono PET și PP sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_2.jpg', title: 'Caserole PET/PE', desc: 'Caserolele PET/PE, mono PET și PP sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_2.jpg', title: 'Caserole Skin', desc: 'EXPANDATE SAU RIGIDE, PP / PET/PE.' },
      { img: '/images/ind2_6.jpg', title: 'Caserole PSE', desc: 'EXPANDATE SAU RIGIDE, PP / PET/PE.' },
      { img: '/images/ind1_2.jpg', title: 'Cartoane Skin', desc: 'Ambalarea în „skin” este sistemul de ambalare care prelungește durata de viață a alimentelor, deoarece elimină complet aerul.' },
      { img: '/images/ind1_2.jpg', title: 'Caserole Mono PET', desc: 'Caserolele PET/PE, mono PET și PP sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
  ...
  },
  {
    ...
    subcategorii: [
      { img: '/images/ind1_2.jpg', title: 'Pungi vid gofrate', desc: 'Barieră și înaltă barieră · Grosimi cuprinse între 50 și 300 μm.' },
      { img: '/images/ind3_1.jpg', title: 'Pungi vid termocontractibile pentru carne', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      ...
      { img: '/images/ind1_2.jpg', title: 'Folii FlowVac termocontractibile', desc: ' ' },
      { img: '/images/ind3_3.jpg', title: 'Folii din polietilenă', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_2.jpg', title: 'Saci pentru navete', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind3_4.jpg', title: 'Caserole PP', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_2.jpg', title: 'Caserole PET/PE', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      ...
      { img: '/images/ind1_2.jpg', title: 'Cartoane Skin', desc: ' ' },
      { img: '/images/ind1_2.jpg', title: 'Membrane poliamidice', desc: ' ' },
    ],
  },
  {
    ...
    subcategorii: [
      { img: '/images/ind1_29.jpg', title: 'Filme flexibile', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'Filme rigidе', desc: 'Sunt utilizate pentru producerea ambalajelor folosind un proces de termoformare.' },
      ...
      { img: '/images/ind1_29.jpg', title: 'Filme Flow-Pack microperforate', desc: 'Filme destinate special produselor crud-uscate, produselor leguminoase, de panificație.' },
      { img: '/images/ind1_29.jpg', title: 'Folii Stretch alimentare', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'Folii Poliolefină termocontractibile', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate..' },
      { img: '/images/ind1_29.jpg', title: 'Folii din polietilenă', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'Saci pentru navete', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE .' },
      { img: '/images/ind4_11.jpg', title: 'Caserole PP', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată,.' },
      { img: '/images/ind1_29.jpg', title: 'Caserole PET/PE', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind4_13.jpg', title: 'Caserole PSE', desc: 'EXPANDATE SAU RIGIDE, PP / PET/PE.' },
      { img: '/images/ind4_14.jpg', title: 'Caserole Mono PET', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
    ],
  },
  {
    ...
    subcategorii: [
      ...
      { img: '/images/ind1_29.jpg', title: 'PUNGI VID GOFRATE', desc: 'Barieră și înaltă barieră · Grosimi cuprinse între 50 și 300 μm.' },
      { img: '/images/ind1_29.jpg', title: 'FILME FLEXIBILE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'FILME TERMOSUDARE CASEROLE (ATM)', desc: 'FILME SUPERIOARE pentru ambalarea în atmosferă modificată.' },
      { img: '/images/ind5_5.jpg', title: 'FILME FLOW-PACK LAMINATE', desc: 'FILMELE pentru Flow-Pack – în variantele laminate sau nelaminate.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII STRETCH ALIMENTARE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII POLIETILENA', desc: ' ' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PP', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PET/PE', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PSE', desc: 'EXPANDATE SAU RIGIDE, PP / PET/PE.' },
      { img: '/images/ind1_29.jpg', title: 'Mono PET', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
    ],
  },
  {
    ...
    subcategorii: [
      ...
      { img: '/images/ind1_29.jpg', title: 'FILME RIGIDE', desc: 'sunt utilizate pentru producerea ambalajelor folosind un proces de termoformare.' },
      { img: '/images/ind1_29.jpg', title: 'FILME LAMINATE', desc: 'FILMELE pentru Flow-Pack – în variantele laminate sau nelaminate.' },
      { img: '/images/ind1_29.jpg', title: 'FILME TERMOSUDARE CASEROLE (ATM)', desc: 'FILME SUPERIOARE pentru ambalarea în atmosferă modificată.' },
      { img: '/images/ind6_6.jpg', title: 'FILME FLOW-PACK LAMINATE', desc: 'FILMELE pentru Flow-Pack – în variantele laminate sau nelaminate.' },
      { img: '/images/ind1_29.jpg', title: 'FILME FLOW-PACK MICROPERFORATE', desc: 'Filme destinate special produselor crud-uscate, produselor leguminoase, de panificație.' },
      { img: '/images/ind6_8.jpg', title: 'Filme Flow-Pack macroperforate', desc: 'Filme destinate special produselor crud-uscate, produselor leguminoase, de panificație.' },
      { img: '/images/ind6_9.jpg', title: 'FOLII STRETCH ALIMENTARE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind6_10.jpg', title: 'FOLII POLIOLEFINĂ TERMOCONTRACTIBILĂ', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII POLIETILENA', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'SACI NAVETE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PP', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PET/PE', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PSE', desc: 'EXPANDATE SAU RIGIDE, PP / PET/PE.' },
      { img: '/images/ind6_16.jpg', title: 'Mono PET', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
    ],
  },
  {
    ...
    subcategorii: [
      ...
      { img: '/images/ind1_29.jpg', title: 'PUNGI VID TERMOCONTRACTIBILE', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'PUNGI VID TRATAMENTE TERMICE', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      ...
      { img: '/images/ind7_7.jpg', title: 'FILME TERMOSUDARE CASEROLE (ATM)', desc: 'FILME SUPERIOARE pentru ambalarea în atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'FILME SKIN', desc: 'FILME SUPERIOARE pentru ambalarea în vacuum / vid.' },
      { img: '/images/ind7_9.jpg', title: 'FILME FLOW-PACK LAMINATE', desc: 'FILMELE pentru Flow-Pack – în variantele laminate sau nelaminate.' },
      { img: '/images/ind1_29.jpg', title: 'FILME FLOW-PACK MICROPERFORATE', desc: 'Filme destinate special produselor crud-uscate, produselor leguminoase, de panificație.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII STRETCH ALIMENTARE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII STRETCH PALETIZARE MANUALE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII STRETCH PALETIZARE AUTOMATE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII POLIOLEFINĂ TERMOCONTRACTIBILĂ', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII FLOWVAC TERMOCONTRACTIBILE', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'FOLII POLIETILENA', desc: 'Sunt produse să acopere o gamă variată de aplicații – ambalarea produselor din carne, pește și a brânzeturilor fermentate.' },
      { img: '/images/ind1_29.jpg', title: 'SACI NAVETE', desc: 'Filmele de Termoformare flexibile tip PA/PE, PP/PA/PE sau PP/PE.' },
      { img: '/images/ind7_18.jpg', title: 'CASEROLE PP', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'CASEROLE PET/PE', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      ...
      { img: '/images/ind1_29.jpg', title: 'CARTOANE SKIN', desc: ' ' },
      { img: '/images/ind7_23.jpg', title: 'Mono PET', desc: 'Sunt proiectate pentru a fi utilizate în procesul de ambalare cu atmosferă modificată.' },
      { img: '/images/ind1_29.jpg', title: 'RUMEGUȘ PENTRU AFUMARE', desc: 'Esența lemnului pur, pentru o aromă tradițională inconfundabilă.' },
    ],
  },
  {
...
const STATS = [
  { value: '9+', label: 'Industrii deservite' },
...
export default function Industrii() {
  ...
  const filtered = activeFilter === 'Toate' ? ALL : ALL.filter(i => i.filter === activeFilter);
        ...
        <div style={{ position: 'relative', overflow: 'hidden', background: '#0a0b14' }}>
          ...
          <div className="container" style={{ position: 'relative', zIndex: 1, padding: '80px 32px 64px' }}>
            <div className="breadcrumb">
              ...
              <Link to="/industrii">Industrii</Link><span className="sep">/</span>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center', marginTop: 8 }}>
              <div>
                ...
                <p style={{ color: 'rgba(255,255,255,0.38)', fontSize: '1rem', lineHeight: 1.8, maxWidth: 420, marginBottom: 36 }}>
                  {item.desc} Oferim soluții complete de ambalare adaptate cerințelor specifice ale acestei industrii.
                </p>
                <div style={{ display: 'flex', gap: 10 }}>
                  <Link to="/despre#contact" className="btn btn-red" style={{ borderRadius: 99 }}>Solicitați ofertă</Link>
                  <Link to="/industrii" className="btn btn-outline" style={{ borderRadius: 99 }}>← Înapoi</Link>
                </div>
              </div>
        ...
        <section className="section" style={{ background: '#080910' }}>
          <div className="container">
            <Reveal style={{ marginBottom: 48 }}>
              <div className="section-eyebrow">Soluții disponibile</div>
              <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 'clamp(1.6rem, 3vw, 2.4rem)', fontWeight: 400, fontStyle: 'italic', color: '#fff', letterSpacing: '-0.03em' }}>
                Soluții pentru <span style={{ color: '#e74c3c' }}>{item.title}</span>
              </h2>
            </Reveal>
              ...
              <div style={{ background: 'linear-gradient(135deg, #0f1019, #0c0d16)', border: '1px solid rgba(231,76,60,0.2)', borderRadius: 20, padding: '40px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 32, flexWrap: 'wrap', position: 'relative', overflow: 'hidden' }}>
                ...
                <div>
                  <h3 style={{ fontFamily: "'Instrument Serif', serif", fontSize: '1.6rem', fontWeight: 400, color: '#fff', marginBottom: 8 }}>
                    Nu găsiți soluția potrivită?
                  </h3>
                  <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.88rem', lineHeight: 1.7 }}>
                    Oferim soluții personalizate pentru orice cerință specifică industriei dumneavoastră.
                  </p>
                </div>
                <div style={{ display: 'flex', gap: 12 }}>
                  <Link to="/despre#contact" className="btn btn-red" style={{ borderRadius: 99 }}>Contactați-ne</Link>
                  <Link to="/industrii" className="btn btn-outline" style={{ borderRadius: 99 }}>Toate industriile</Link>
                </div>
              </div>
            </Reveal>
          </div>
      ...
      <div style={{ position: 'relative', overflow: 'hidden', background: '#0a0b14' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, padding: '80px 32px 64px' }}>
          <div className="breadcrumb">
            ...
            <span className="current">Industrii</span>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div>
              <div className="section-eyebrow">Sectoare deservite</div>
              <h1 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 'clamp(2.4rem, 5vw, 4rem)', fontWeight: 400, fontStyle: 'italic', color: '#fff', letterSpacing: '-0.03em', lineHeight: 1.08, marginBottom: 20 }}>
                Toate<br /><span style={{ color: '#e74c3c' }}>industriile</span> noastre
              </h1>
              <p style={{ color: 'rgba(255,255,255,0.38)', fontSize: '1rem', lineHeight: 1.8, maxWidth: 420, marginBottom: 36 }}>
                Experiență și soluții specializate pentru toate sectoarele economice majore din industria alimentară și cea industrială.
              </p>
              <div style={{ display: 'flex', gap: 10 }}>
                <Link to="/despre#contact" className="btn btn-red" style={{ borderRadius: 99 }}>Solicitați ofertă</Link>
          ...
          <Reveal>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 48, flexWrap: 'wrap', gap: 16, paddingBottom: 24, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              <div style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.3)' }}>
                <span style={{ color: '#fff', fontWeight: 600 }}>{filtered.length}</span> industrii disponibile
              </div>
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                {['Toate', 'Alimentar', 'HoReCa', 'Industrial'].map((f) => (
              ...
              <div style={{ background: 'linear-gradient(135deg, #0f1019, #0c0d16)', border: '1px solid rgba(231,76,60,0.2)', borderRadius: 20, padding: '52px 60px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 40, flexWrap: 'wrap', position: 'relative', overflow: 'hidden' }}>
                ...
                <div>
                  ...
                  <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 'clamp(1.4rem, 3vw, 2rem)', fontWeight: 400, color: '#fff', letterSpacing: '-0.03em', marginBottom: 8 }}>
                    Nu găsiți industria dvs.?
                  </h2>
                  <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.88rem', maxWidth: 380, lineHeight: 1.7 }}>
                    Oferim soluții personalizate pentru orice sector. Contactați-ne pentru o consultație gratuită.
                  </p>
                </div>
